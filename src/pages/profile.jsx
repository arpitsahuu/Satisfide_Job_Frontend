    ...
    <Layout>
      ...
      <div className="w-auto flex flex-col md:flex-row justify-center gap-4 px-2 min-h-[100vh] md:mt-[100px]">
        ...
        <div className="flex  flex-col gap-3 items-center">
            ...
            <div>
              <form ref={formRefResuma} onSubmit={handleSubmitResuma} className="hidden" >
                <input ref={inputRefResuma} onChange={handleFileChangeResuma} type="file" name="resume" accept=".pdf" id="pdfFile" />
                <button type="submit" ref={btnRefResuma}> submit</button>
              </form>
            </div>
            <button className="w-full hover:bg-sky-800 py-2 px-4 bg-sky-600 text-white font-medium rounded-md hover:bg-blue-700 transition duration-200 ease-in-out" onClick={() =>handleResumeClick()} >Add resume</button>
